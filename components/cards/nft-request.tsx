...
export default function NFTRequest({
  message,
  action,
  id,
}: {
      ...
      <div className="mt-2 rounded-xl bg-white px-6 py-4">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <p className="font-medium md:text-xl">{formatAddress(receiver)}</p>
          </div>
          <div className="flex items-center gap-2">
            <img
              src={tokenData?.logo}
        ...
        <div className="mt-4 flex flex-wrap items-end justify-between">
          <div className="flex gap-2">
            <img
              src="https://images.unsplash.com/photo-1643888193686-81c45c445b95?q=80&w=2080&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt=""
              className="h-24 w-24 rounded-lg"
            />
            <p className="font-medium md:text-lg">Azuki #2997</p>
          </div>
